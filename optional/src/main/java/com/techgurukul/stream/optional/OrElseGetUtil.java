...
public class OrElseGetUtil {

	private static final Logger LOGGER = Logger.getLogger(OrElseGetUtil.class.getName());
	...
	public static Optional<StudentDTO> toStudentDtoSinceJava8(Student student) {
		...
		studentDTO.setRollNumber(Optional.ofNullable(student.getRollNumber()).orElseGet(OrElseGetUtil::getRollNumber));
